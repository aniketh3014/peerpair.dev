...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="min-h-[200vh] flex flex-col items-center justify-start flex-shrink-0 [perspective:800px] transform md:scale-90 scale-75 md:scale-80 lg:scale-125 lg:py-60 w-full"
    >
      <motion.h2
        style={{
  ...
  return (
    <div className="relative [perspective:800px]">
      ...
      <motion.div
        ...
        className="h-96 w-[32rem] absolute inset-0 bg-[#010101] rounded-2xl p-2 flex items-center justify-center"
      >
